    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <br><br><br>
                <h1>
                    <center>Repo Kalkulator</center>
                    <hr>
                </h1>
                <center>
                    <p>Repo Kalkulator merupakan kumpulan Kalkulator <br>
                        untuk berbagai kebutuhan yang dibuat sedemikian untuk <br>
                        membantu dan mempermudah berhitung.</p>
                </center>
            </div>
        </div>
    </div>
